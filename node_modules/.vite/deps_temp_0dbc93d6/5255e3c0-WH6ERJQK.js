...
// node_modules/lowcoder-sdk/dist/5255e3c0.js
var import_react = __toESM(require_react(), 1);
var import_react_dom = __toESM(require_react_dom(), 1);
var Z = [{
  label: _("step.sizeSmall"),
  value: "small"
}, {
  label: _("step.sizeDefault"),
  value: "default"
}];
var A = [{
  label: _("step.typeDefault"),
  value: "default"
}, {
  label: _("step.typeNavigation"),
  value: "navigation"
}, {
  label: _("step.typeInline"),
  value: "inline"
}];
var v = [{
  label: _("step.directionHorizontal"),
  value: "horizontal"
}, {
  label: _("step.directionVertical"),
  value: "vertical"
}];
_("step.statusProcess"), _("step.statusWait"), _("step.statusFinish"), _("step.statusError");
var G = {
  initialValue: JU1("1"),
  value: QU1("value"),
  stepStatus: QU1("process"),
  stepPercent: JU1("60"),
  size: ca(Z, "default"),
  displayType: ca(A, "default"),
  direction: ca(v, "horizontal"),
  showDots: ao,
  showIcons: ao,
  selectable: ao,
  labelPlacement: ca(v, "horizontal"),
  disabled: H3,
  onEvent: N11,
  options: LU1,
  style: nc(kW1, "style"),
...
var J = function() {
  return new VS(G, (t) => {
    ...
    ${(s) => s.$animationStyle}
      min-height: 24px;
      max-width: ${qse(t.style.margin)};
      max-height: ${Gse(t.style.margin)};
      display: flex;
    ...
    `, [S, y] = (0, import_react.useState)(t.initialValue.value - 1);
    ...
    return d(gh, {
      ...
      children: d(f, {
        ...
        children: d(d22, {
          ...
          children: t.options.map((s, n) => d(d22.Step, {
            title: s.label,
            subTitle: s.subTitle,
            description: s.description,
            status: s.status,
            icon: t.showIcons && BXe(s.icon) && s.icon || void 0
          }, n))
        })
      })
    });
    ...
    children: [N2(ka, {
      ...
      children: [t.options.propertyView({}), t.initialValue.propertyView({
        label: _("step.initialValue"),
        tooltip: _("step.initialValueTooltip")
      })]
    }), ["logic", "both"].includes((0, import_react.useContext)(Vr).editorModeStatus) && d(p1, {
      children: N2(ka, {
        name: b0.interaction,
        children: [t.onEvent.getPropertyView(), qC(t), E7(t), t.stepStatus.propertyView({
          label: _("step.status")
        }), t.stepPercent.propertyView({
          label: _("step.percent")
        }), t.selectable.propertyView({
          label: _("step.selectable")
        })]
      })
    }), ["layout", "both"].includes((0, import_react.useContext)(Vr).editorModeStatus) && N2(ka, {
      name: b0.layout,
...
var q = H0(J, [new vo("value", _("step.valueDesc")), new vo("stepStatus", _("step.status")), new vo("stepPercent", _("step.percent")), ...RQe]);
export {
  q as StepComp
};
//# sourceMappingURL=5255e3c0-WH6ERJQK.js.map
