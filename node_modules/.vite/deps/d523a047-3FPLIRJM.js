...
// node_modules/lowcoder-sdk/dist/d523a047.js
...
var w = function() {
  ...
  return new g2(e, (t) => t.v1).setPropertyViewFn(p).build();
}();
var u = E3(w);
function o(e) {
  let t = new u({
...
test("array move", () => {
  ...
  expect(Dte(e, 8, 3)).toEqual([0, 1, 2, 8, 3, 4, 5, 6, 7, 9]), expect(Dte(e, 0, 4)).toEqual([1, 2, 3, 4, 0, 5, 6, 7, 8, 9]);
});
test("list actions", () => {
  let e = new u({
    value: []
...
//# sourceMappingURL=d523a047-3FPLIRJM.js.map
