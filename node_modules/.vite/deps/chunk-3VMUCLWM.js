...
// node_modules/lowcoder-sdk/dist/48a13bee.js
...
var b = function() {
  ...
  })).setPropertyViewFn((e) => d(p1, {
    children: d(T, {
      ...e
    })
  })).setExposeMethodConfigs(TQe([J11, tt1])).build();
}();
var g = H0(b, [new vo("value", _("selectInput.valueDesc")), ...RQe]);
var E = t2(g, {
  options: L
});
...
//# sourceMappingURL=chunk-3VMUCLWM.js.map
