...
// node_modules/lowcoder-sdk/dist/da4dc0ad.js
    ...
    if (typeof a != "string" && !Array.isArray(a)) {
      for (const f in a)
        if (f !== "default" && !(f in c)) {
          ...
          i && Object.defineProperty(c, f, i.get ? i : {
            enumerable: true,
            get: () => a[f]
          });
        }
...
(function(c) {
  ...
  var u = P(import_react.default), l = i(s), a = i(Qse);
  function f(e, t, r) {
  ...
  var w = function(e, t) {
    return u.createElement(a.default, b(m({}, e), {
      ref: t,
      icon: l.default
    }));
  }, v = u.forwardRef(w);
  v.displayName = "GifOutlined";
  var D = v;
})(g);
(function(c, u) {
...
//# sourceMappingURL=da4dc0ad-SFYDSDAX.js.map
