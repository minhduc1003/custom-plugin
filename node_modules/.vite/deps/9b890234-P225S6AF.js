...
// node_modules/lowcoder-sdk/dist/9b890234.js
    ...
    if (typeof u != "string" && !Array.isArray(u)) {
      for (const c in u)
        if (c !== "default" && !(c in p)) {
          ...
          a && Object.defineProperty(p, c, a.get ? a : {
            enumerable: true,
            get: () => u[c]
          });
        }
...
(function(p) {
  ...
  var T = function(e, t) {
    return o.createElement(u.default, P(m({}, e), {
      ref: t,
      icon: f.default
    }));
  }, O = o.forwardRef(T);
  O.displayName = "AppstoreTwoTone";
  var b = O;
})(w);
(function(p, o) {
...
//# sourceMappingURL=9b890234-P225S6AF.js.map
