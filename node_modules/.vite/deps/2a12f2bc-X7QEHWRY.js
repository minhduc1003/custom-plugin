...
function xe(e2) {
  ...
  for (; ++n < e2.length; ) {
    ...
    if (l === 37 && r1e(e2.charCodeAt(n + 1)) && r1e(e2.charCodeAt(n + 2)))
      ...
      l < 56320 && a > 56319 && a < 57344 ? (u = String.fromCharCode(l, a), i = 1) : u = "�";
    } else
    ...
    if (F && N.push(null), E.previous = l, l && (l.next = E), l = E, i.defineSkip(E.start), i.write(N), t.parser.lazy[E.start.line]) {
      ...
      for (; d2--; )
        if (
          ...
          i.events[d2][1].start.offset < u && // …and either is not ended yet…
          (!i.events[d2][1].end || // …or ends after it.
...
lowcoder-sdk/dist/2a12f2bc.js:
   ...
   *)
*/
//# sourceMappingURL=2a12f2bc-X7QEHWRY.js.map
