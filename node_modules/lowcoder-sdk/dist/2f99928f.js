import { mJ as b, i6 as W } from "./c988e26e.js";
import D from "react";
function z(c, i) {
...
(function(c) {
  ...
  var i = /* @__PURE__ */ y(D), f = /* @__PURE__ */ a(m), l = /* @__PURE__ */ a(b);
  function u(e, r, t) {
  ...
  var k = function(e, r) {
    return /* @__PURE__ */ i.createElement(l.default, M(g({}, e), {
      ref: r,
      icon: f.default
    }));
  }, s = /* @__PURE__ */ i.forwardRef(k);
  process.env.NODE_ENV !== "production" && (s.displayName = "MediumWorkmarkOutlined");
  var w = s;
})(_);
(function(c, i) {
  ...
  const u = f;
  i.default = u, c.exports = u;
})(v, v.exports);
var h = v.exports;
const E = /* @__PURE__ */ W(h), x = /* @__PURE__ */ z({
  __proto__: null,
  default: E
}, [h]);
export {
