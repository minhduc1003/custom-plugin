import { mJ as I, i6 as M } from "./c988e26e.js";
import V from "react";
function D(f, c) {
    ...
    if (typeof i != "string" && !Array.isArray(i)) {
      for (const u in i)
        if (u !== "default" && !(u in f)) {
          ...
          a && Object.defineProperty(f, u, a.get ? a : {
            enumerable: !0,
            get: () => i[u]
          });
        }
...
(function(f) {
  ...
  var c = /* @__PURE__ */ w(V), o = /* @__PURE__ */ a(v), i = /* @__PURE__ */ a(I);
  function u(e, t, r) {
  ...
  process.env.NODE_ENV !== "production" && (O.displayName = "InsuranceTwoTone");
  var b = O;
})(h);
(function(f, c) {
