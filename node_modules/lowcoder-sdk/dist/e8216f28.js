...
function M(f, a) {
  for (var o = 0; o < a.length; o++) {
    ...
    if (typeof c != "string" && !Array.isArray(c)) {
      for (const i in c)
        if (i !== "default" && !(i in f)) {
          const n = Object.getOwnPropertyDescriptor(c, i);
          n && Object.defineProperty(f, i, n.get ? n : {
            enumerable: !0,
            get: () => c[i]
          });
        }
...
(function(f) {
  ...
  var a = /* @__PURE__ */ P(F), o = /* @__PURE__ */ n(_), c = /* @__PURE__ */ n(C);
  function i(e, r, t) {
  ...
  function m(e) {
    for (var r = 1; r < arguments.length; r++) {
      ...
      typeof Object.getOwnPropertySymbols == "function" && (l = l.concat(Object.getOwnPropertySymbols(t).filter(function(u) {
  ...
  var w = function(e, r) {
    return /* @__PURE__ */ a.createElement(c.default, h(m({}, e), {
      ref: r,
      icon: o.default
    }));
  }, O = /* @__PURE__ */ a.forwardRef(w);
  process.env.NODE_ENV !== "production" && (O.displayName = "AlipayCircleFilled");
  var A = O;
})(v);
(function(f, a) {
...
var g = s.exports;
const E = /* @__PURE__ */ D(g), N = /* @__PURE__ */ M({
  __proto__: null,
  default: E
}, [g]);
export {
