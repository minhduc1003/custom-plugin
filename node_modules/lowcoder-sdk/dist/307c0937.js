    ...
    if (typeof i != "string" && !Array.isArray(i)) {
      for (const l in i)
        if (l !== "default" && !(l in f)) {
          ...
          c && Object.defineProperty(f, l, c.get ? c : {
            enumerable: !0,
            get: () => i[l]
          });
        }
...
(function(f) {
  ...
  var a = /* @__PURE__ */ m(D), o = /* @__PURE__ */ c(_), i = /* @__PURE__ */ c(C);
  function l(e, r, t) {
  ...
  var b = function(e, r) {
    return /* @__PURE__ */ a.createElement(i.default, S(P({}, e), {
      ref: r,
      icon: o.default
    }));
  }, v = /* @__PURE__ */ a.forwardRef(b);
  process.env.NODE_ENV !== "production" && (v.displayName = "SlackCircleFilled");
  var w = v;
})(y);
(function(f, a) {
  ...
  const l = o;
  a.default = l, f.exports = l;
})(s, s.exports);
var g = s.exports;
const z = /* @__PURE__ */ M(g), x = /* @__PURE__ */ F({
  __proto__: null,
  default: z
}, [g]);
export {
