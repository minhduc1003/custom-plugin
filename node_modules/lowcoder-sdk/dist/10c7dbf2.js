import { mJ as T, i6 as M } from "./c988e26e.js";
import z from "react";
function j(l, a) {
    ...
    if (typeof u != "string" && !Array.isArray(u)) {
      for (const o in u)
        if (o !== "default" && !(o in l)) {
          ...
          c && Object.defineProperty(l, o, c.get ? c : {
            enumerable: !0,
            get: () => u[o]
          });
        }
...
(function(l) {
  ...
  var a = /* @__PURE__ */ b(z), f = /* @__PURE__ */ c(_), u = /* @__PURE__ */ c(T);
  function o(e, t, r) {
  ...
  var m = function(e, t) {
    return /* @__PURE__ */ a.createElement(u.default, P(w({}, e), {
      ref: t,
      icon: f.default
    }));
  }, v = /* @__PURE__ */ a.forwardRef(m);
  process.env.NODE_ENV !== "production" && (v.displayName = "DashboardTwoTone");
  var D = v;
})(O);
(function(l, a) {
  ...
  const o = f;
  a.default = o, l.exports = o;
})(s, s.exports);
var g = s.exports;
const A = /* @__PURE__ */ M(g), N = /* @__PURE__ */ j({
  __proto__: null,
  default: A
}, [g]);
export {
